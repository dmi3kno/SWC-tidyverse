...
When talking about vectors in R two important concepts need to be mentioned: recycling and coersion.

R is built by statisticians for interactive data analysis. It is designed to give the answers quickly and allows the knowledgeable user to "cut corners". R is notoriously loose about many requirements that are strictly monitored in other languages. Recycling and coersion are two fine examplex of this inherent flexibility of R.
...
R pick the "lowest common denominator" for reconciling the type conflict among the members of the vector and "demotes" its elements into this type. Coersion into character is ofter the fallback option for R. Logical vectors are easily coercible into 0s and 1s.
...
gapminder[[4]][12] # life expectancy in Afganistan in 2007
gapminder[["lifeExp"]][12] # life expectancy in Afganistan in 2007
...
# integer subsetting
gapminder[12, 4] # life expectancy in Afganistan in 2007
