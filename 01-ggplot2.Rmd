...
download.file(url1, file.path("data", "gapminder_long.csv"))
download.file(url2, file.path("data", "gapminder_wide.csv"))
gapminder <- read_csv(file.path("data", "gapminder_long.csv"))
```
